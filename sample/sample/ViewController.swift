...
extension ViewController: IMUIInputViewDelegate {
    ...
    func sendTextMessage(_ messageText: String) {
        ...
        let customMessage = MessageEventModel(msgId: "\(NSDate().timeIntervalSince1970 * 1000)", eventText: "系统消息：买家标记为已付款，等待卖家释放币")
        self.messageCollectionView.appendMessage(with: customMessage)
