...
class MyMessageModel: IMUIMessageModel {
  ...
  convenience init(text: String, isOutGoing: Bool) {
    ...
    self.init(msgId: msgId, messageStatus: .success, fromUser: MyUser(), isOutGoing: isOutGoing, date: Date(), type: "text", text: text, mediaPath: "", layout:  myLayout, duration: nil)
  }
