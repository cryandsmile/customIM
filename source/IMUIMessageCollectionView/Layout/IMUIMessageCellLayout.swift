...
func SCALEDLENGTH(length:CGFloat) ->CGFloat {
    return CGFloat(floorf(Float(length / RATIOTO6p())))
}

func RATIOTO6p() -> CGFloat {
    return((SCREEN_WIDTH == 414.0) ? 1.0 : ((SCREEN_WIDTH == 375.0) ? 1.1 : ((SCREEN_WIDTH == 320.0) ? 1.29 : 1.0)))
...
@objc open class IMUIMessageCellLayout: NSObject, IMUIMessageCellLayoutProtocol {
  ...
  @objc public static var bubbleMaxWidth: CGFloat = SCALEDLENGTH(length: 250.0)
